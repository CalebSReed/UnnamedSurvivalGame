...
public class GameManager : MonoBehaviour
{
    ...
    private void SavePlayerInventory()
    {
        ...
        {
            PlayerPrefs.SetInt($"SaveItemType{i}", (int)player.GetComponent<PlayerMain>().inventory.GetItemList()[i].itemType);
            PlayerPrefs.SetInt($"SaveItemAmount{i}", player.GetComponent<PlayerMain>().inventory.GetItemList()[i].amount);
        ...
        {
            PlayerPrefs.SetInt($"SaveHandItemType", (int)player.GetComponent<PlayerMain>().handSlot.item.itemType);
    ...
    private void LoadPlayerInventory()
    {
        ...
        while (i < PlayerPrefs.GetInt("InventorySize"))//each item in inventory
        {
            ...
            player.GetComponent<PlayerMain>().inventory.SimpleAddItem(new Item { itemType = (Item.ItemType)PlayerPrefs.GetInt($"SaveItemType{i}"), amount = PlayerPrefs.GetInt($"SaveItemAmount{i}"), uses = PlayerPrefs.GetInt($"SaveItemUses{i}"), ammo = PlayerPrefs.GetInt($"SaveItemAmmo{i}") });
            i++;
        }
